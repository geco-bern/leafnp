...
df_sites <- read_csv("~/data/LeafNP_tiandi/Global_total_leaf_N_P_Di/df_sites_leafnp_20210324.csv")
...
Problematic `soil_N` and `soil_P` with 88% missing. Not sure whey they came from. Did you rename them, Di? 
I suspect they are from WISE and GSDE.

```{r}
df_wise <- read_csv("data/df_wise_20210324.RData")
```
