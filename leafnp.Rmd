...
df_etopo <- ingest(
  ...
  ungroup() %>% 
  dplyr::select(elv_etopo = elv, -sitename)
...
write_csv(df_cells, file = "data/df_cells.csv")
```
...
rbeni::extract_pointdata_allsites(
  filename = "~/data/sofun_outputs/global_FULL_MODIS-C006_MOD15A2_v1.4-12-g1b77a9e/global_FULL_MODIS-C006_MOD15A2_v1.4-12-g1b77a9e.a.pet_MEANANN.nc",
