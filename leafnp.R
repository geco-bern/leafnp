...
write_csv(df, file = "~/data/LeafNP_tiandi/Global_total_leaf_N_P_Di/global_leaf_NP_total_Di_20210324_PROC.csv")
...
write_csv(df_sites, file = "~/data/LeafNP_tiandi/Global_total_leaf_N_P_Di/df_sites_leafnp_20210324.csv")
write_csv(df_sites, file = "data/df_sites_leafnp_20210324.csv")
...
save(df_wise, file = "data/df_wise_20210324.RData")
...
## -------------------------------------------------------------------------------------
filn <- "data/df_gti_20210324.RData"
if (!file.exists(filn)){
...
save(df_co2, file = "data/df_co2_20210324.RData")


## -------------------------------------------------------------------------------------
filn <- "data/df_ndep_20210324.RData"
if (!file.exists(filn)){
  df_ndep <- ingest(
    df_sites %>% 
...
save(df_ndep_agg, file = "data/df_ndep_20210324.RData")
...
load("data/df_gsde_20210324.RData") # df_gsde
