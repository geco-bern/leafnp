...
if (!file.exists(filn)){
  ...
  dfs_wwf <- ingestr::ingest(
    ...
    unnest(data) |> 
    select(sitename, biome_wwf = BIOME_NAME) |> 
...
#   min.node.size  RMSE      Rsquared   MAE     
#    5             4.845727  0.4556901  3.474374
#   10             4.879364  0.4486083  3.499563
#   20             4.924898  0.4388536  3.532184
#   30             4.961296  0.4310342  3.564307
#   50             5.021667  0.4177730  3.607971
# 
# Tuning parameter 'mtry' was held constant at a value of 5
# Tuning parameter 'splitrule'
#  was held constant at a value of variance
# RMSE was used to select the optimal model using the smallest value.
