...
write_csv(df_fe_summary, file = paste0(here::here(), "/data/df_fe_summary_leafn.csv"))
```
...
write_csv(df_fe_summary, file = paste0(here::here(), "/data/df_fe_summary_leafp.csv"))
```
...
write_csv(df_fe_summary, file = paste0(here::here(), "/data/df_fe_summary_leafnp.csv"))
```
